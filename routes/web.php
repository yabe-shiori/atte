...
//休憩
Route::post('/start-break', [BreakTimeController::class, 'startBreak'])->name('start-break');
Route::post('/end-break', [BreakTimeController::class, 'endBreak'])->name('end-break');
// 勤怠一覧画面
...
// Route::get('profile/user_attendance', [AttendanceController::class, 'userAttendance'])
//     ->name('user_attendance');
Route::get('profile/user-attendance/{user}', [UserController::class, 'showAttendance'])
